      ...
      (function (Et, zt) {
        (function (C, De) {
          ...
          function d(e, t, n, r) {
            ...
            if (
              (n && (i.className = n), r && (i.style.cssText = r), typeof t == 'string')
            )
...
`,
          ...
          function mo(e, t, n) {
            if (!t.styles || t.styles[0] != e.state.modeGen) {
              var r = fn(e, f(t)),
                i =
                  t.text.length > e.options.maxHighlightLength && Gt(e.doc.mode, r.state),
                o = vo(e, t, r);
              (i && (r.state = i),
          ...
          function Ha(e, t, n) {
            for (
              ...
              var s = ce(o, a - 1),
                u = s.stateAfter;
              if (u && (!n || a + (u instanceof Hn ? u.lookAhead : 0) <= o.modeFrontier))
                return a;
...
`
          ...
          function hs(e, t, n) {
            ...
            for (
              var r = H('CodeMirror-linewidget'), i = t.node.firstChild, o = void 0;
              i;
              i = o
            )
          ...
          function Tr(e, t, n, r) {
            ...
            if (r && s.xRel > 0 && (u = ce(e.doc, s.line).text).length == s.ch) {
              ...
              s = L(
                s.line,
                Math.max(0, Math.round((o - Ho(e.display).left) / Kr(e.display)) - h)
              );
            }
            return s;
          }
          ...
          function tl(e, t) {
            ...
            for (var a = 0; a < n.sel.ranges.length; a++)
              if (!(!t && a == n.sel.primIndex)) {
                ...
                if (
                  !(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)
                ) {
                  var u = s.empty();
                  if (l) {
                    var h = l(e, s);
          ...
          function zs(e) {
            ...
            if (o)
              for (var a = 0; a < o.length; ++a) o[a].lines.length || Ye(o[a], 'hide');
            if (l)
              for (var s = 0; s < l.length; ++s) l[s].lines.length && Ye(l[s], 'unhide');
          ...
          function wl(e, t, n, r) {
            ...
            e.iter(Math.max(e.first, n), Math.min(e.first + e.size, r), function (l) {
              (l.markedSpans && ((i || (i = t['spans_' + e.id] = {}))[o] = l.markedSpans),
                ++o);
            });
          }
          function Zs(e) {
          ...
          function li(e, t, n) {
            (Ct(e, 'beforeSelectionChange') ||
              ...
              (t = Qs(e, t, n));
            var r =
              (n && n.bias) || (Z(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
            (Dl(e, Fl(e, t, r, !0)),
              !(n && n.scroll === !1) &&
                e.cm &&
          ...
          function Vr(e, t, n, r, i) {
            ...
            var o = new mr(e, i),
              l = Z(t, n);
            if ((r && Te(r, o, !1), l > 0 || (l == 0 && o.clearWhenEmpty !== !1)))
              return o;
            if (
              (o.replacedWith &&
                ((o.collapsed = !0),
...
`,
          ...
          function Su(e, t, n, r) {
            var i = e.display,
              ...
              a = function (u) {
                o =
                  o ||
                  Math.abs(t.clientX - u.clientX) + Math.abs(t.clientY - u.clientY) >= 10;
              },
              s = function () {
                return (o = !0);
              };
          ...
          function Tu(e, t, n, r) {
            ...
            r.addNew
              ? a == -1
                ? ((a = u.length),
                  pt(o, Kt(e, u.concat([l]), a), { scroll: !1, origin: '*mouse' }))
          ...
          function Du(e) {
            ...
            ((e.defineOption = n),
              ...
              n(
                ...
                !0,
                function (r, i) {
                  ((r.display.gutters.style.left = i ? zi(r.display) + 'px' : '0'),
                    r.refresh());
                },
                !0
              ),
...
`)));
            ...
            (je.prototype.pollContent = function () {
              ...
              for (
                ...
                M < ee &&
                Q.charCodeAt(Q.length - M - 1) == G.charCodeAt(G.length - M - 1);
        ...
        (function (C) {
          ...
          C.defineMode('css', function (fe, H) {
            ...
            function Oe(T, B, F, Ie) {
              return (
                (T.context = new ct(F, B.indentation() + (Ie === !1 ? 0 : D), T.context)),
                F
              );
            }
            function Re(T) {
            ...
            return (
              ...
              (Pe.at = function (T, B, F) {
                return T == ';'
                  ...
                  : T == '{' || T == '}'
                    ? et(T, B, F)
                    : (T == 'word' ? (be = 'tag') : T == 'hash' && (be = 'builtin'),
                      'at');
              }),
        ...
        (function (C) {
          ...
          (C.defineMode('xml', function (K, $) {
            ...
            return {
              ...
              token: function (d, S) {
                if (
                  (!S.tagName && d.sol() && (S.indented = d.indentation()), d.eatSpace())
                )
                  return null;
                ie = null;
            ...
            function j(f, g) {
              var A = function () {
                ...
                if (W.lexical.type == 'stat') L = W.lexical.indented;
                  ...
                  for (var Z = W.lexical; Z && Z.type == ')' && Z.align; Z = Z.prev)
                    L = Z.indented;
            ...
            function (ie, O) {
              ...
              function te(re, ne) {
                ...
                if (
                  ...
                  ne.inTag && ((ne.inTag += re.current()), re.eol() && (ne.inTag += ' '));
                return se;
              }
              return {
                startState: function () {
              ...
              if ((m && (w.indent = S.indentation()), m && V(w).type == 'py')) {
                ...
                if (S.eatSpace()) {
                  ...
                  return (
                    P > y
                      ? H(w)
                      : P < y && D(S, w) && S.peek() != '#' && (w.errorToken = !0),
                    null
                  );
                } else {
                  var le = de(S, w);
                  ...
                  for (c.list = null; be < c.listStack[c.listStack.length - 1]; )
                    (c.listStack.pop(),
                      c.listStack.length
                        ...
                        : (c.list = !1));
                  c.list !== !1 &&
                    (c.indentationDiff = be - c.listStack[c.listStack.length - 1]);
                }
                var oe =
                    !xe &&
                    !ue &&
                ...
                token: function (p, c) {
                  if (((c.formatting = !1), p != c.thisLine.stream)) {
                    ...
                    if (
                      ...
                      if (((c.indentation = Y), (c.indentationDiff = null), Y > 0))
                        return null;
                    }
                  }
                  return c.f(p, c);
