...
class dt {
  ...
  _mergeSuiteInto(t, e) {
    ...
    (s ||
      ((s = new X(t.title, e.type === 'project' ? 'file' : 'describe')), e._addSuite(s)),
      ...
      onBegin: (t) => {
        ...
        if ((this.rootSuite || (this.rootSuite = t), this._testResultsSnapshot)) {
          for (const s of this.rootSuite.allTests())
            s.results =
              ((e = this._testResultsSnapshot) == null ? void 0 : e.get(s.id)) ||
              s.results;
              ...
              children: [
                ...
                !n &&
                  r.jsx(O, {
                    ...
                    title: 'Watch',
                    onClick: () => {
                      (m.value.has(h.id) ? m.value.delete(h.id) : m.value.add(h.id),
                        c({ ...m }));
                    },
...
`
    ...
    const { testTree: Mt } = u.useMemo(() => {
        if (!a)
          return { testTree: new ut('', new X('', 'root'), [], c, B.pathSeparator, Q) };
        ...
        (p, g) => {
          !v ||
            ...
            (E.current = E.current.then(async () => {
              ...
              (z.write(
                '\x1B[2m—'.repeat(Math.max(0, wt.cols - I.length)) + I + '\x1B[22m'
              ),
            ...
            children: [
              ...
              r.jsx('div', {
                ...
                children: r.jsx(be, {
                  ...
                  item: T,
                  rootDir:
                    (_t = a == null ? void 0 : a.config) == null ? void 0 : _t.rootDir,
                  revealSource: Ct,
                  onOpenExternally: (p) =>
                    v == null
                      ? void 0
            ...
            children: [
              ...
              r.jsxs(H, {
                ...
                children: [
                  !L &&
                    !x &&
                    r.jsx('div', { className: 'section-title', children: 'Tests' }),
                  !L &&
                    x &&
                    r.jsx('div', {
